                    ...
                    <div className="row d-flex justify-content-center">
                        <div className="col-lg-10">
                            ...
                            <div className="d-flex align-items-center mt-5">
                                ...
                                <button data-aos="fade-right" data-aos-delay="600" onClick={() => window.open(require('../assets/images/Shikhar_Resume_updated.pdf'), '_blank')} className="btn resume btn-brand btn-lg btn-outline-dark me-4">
                                    <a href={require('../assets/images/Shikhar_Resume_updated.pdf')} style={{ textDecoration: "none",color:"#491d1d" }} target='_blank' rel="noreferrer">Resume</a>
                                </button>
                                </div>
